...
pygame.draw.circle(display_surface, BLUE, (WINDOW_WIDTH//2,WINDOW_HEIGHT//2), 200, 6)
pygame.draw.circle(display_surface, YELLOW, (WINDOW_WIDTH//2,WINDOW_HEIGHT//2), 195, 0)

#Ractangle(surface, color, (top-left x, top-left y, wight, height))
pygame.draw.rect(display_surface, MAGENTA, (300, 200, 100, 400))
